...
def write_annotation_latin1_hr(handle: int, onset: int, duration: int, description: Union[str, bytes]) -> int: ...
def write_annotation_utf8_hr(handle: int, onset: int, duration: int, description: Union[str, bytes]) -> int: ...
